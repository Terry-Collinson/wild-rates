    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-1 z-20"
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-1 z-20"
        ),
        ...
        dropdown: "cursor-pointer bg-transparent appearance-none border-none p-0 font-medium text-sm focus:outline-none focus:ring-2 focus:ring-primary rounded-md",
