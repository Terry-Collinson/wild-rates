...
export default function AdminPage() {
  ...
  const { data: adminUsers, loading: fetchingAdmins } = useCollection<AdminUser>(adminsQuery);

  // Sync the loading status for the admin table
  useEffect(() => {
    setLoadingAdmins(fetchingAdmins);
  }, [fetchingAdmins]);
